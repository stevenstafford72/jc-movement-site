...
const PricingColumn: React.FC<Props> = ({ tier, highlight }: Props) => {
    ...
    return (
        <div className={clsx(
            ...
            highlight ? "bg-gray-100 border-gray-400 shadow-lg" : "bg-white border-gray-200"
        )}>
            <div className={clsx("p-6 border-b rounded-t-xl", highlight ? "border-gray-400 bg-gray-50" : "border-gray-200")}>
                <h3 className="text-2xl font-bold text-gray-800 mb-4">{name}</h3>
                <p className="text-4xl font-extrabold mb-6 text-gray-900">
                    <span className={highlight ? "text-gray-700" : "text-gray-800"}>
                ...
                <button
                    className={clsx(
                        ...
                        highlight ? "bg-gray-600 hover:bg-yellow-700" : "bg-blue-900 hover:bg-blue-800"
                    )}
                    >
                    <Link
                        href={tier.link}
                    ...
                    >
                        {highlight ? "Registration Closed" : "Register Now"}
                    </Link>
                    </button>
